Shader "Custom/UI/Grayscale"
{
    Properties
    {
        ...
        _UseGrayscale ("Use Grayscale", Float) = 1.0 // New property to enable/disable grayscale
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            uniform float _UseGrayscale; // New uniform to control grayscale
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                // Apply grayscale based on _UseGrayscale
